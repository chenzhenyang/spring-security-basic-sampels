...
public class RSAEncrypt2 {
     ...
     * @throws Exception
     */
    public static PublicKey geneneratePublicKey(byte[] key) throws Exception {
        try {
     ...
     * @throws Exception
     */
    public static PrivateKey geneneratePrivateKey(byte[] key) throws Exception {
        try {
     ...
     * @return
     */
    public static byte[] getKeyFromFile(String pubCerPath) {
        try (InputStream inputStream = Files.newInputStream(Paths.get(pubCerPath));) {
